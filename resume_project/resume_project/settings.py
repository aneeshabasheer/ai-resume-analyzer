...
SECRET_KEY = 'django-insecure-$lf8ci)4=tvcrt7=v3+3*+3a(&+rekglnds-($*nxs6(kndi52'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'aneeshabasheer2026@gmail.com' 
EMAIL_HOST_PASSWORD = 'jabz dwbr qgmb fgjr' # Gmail App Password
